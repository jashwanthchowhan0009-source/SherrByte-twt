"""Phase E — Pydantic schemas for interaction events.

Intentionally split from feed.py so event validation
can be imported without pulling in feed response models.
"""
